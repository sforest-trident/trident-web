...
function trident_web_setup() {
	...
	register_nav_menus(
		array(
			...
			//'footer' => esc_html__( 'Footer Menu', 'trident-web' ),
		)
	);
 ...
 */
function trident_web_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'trident_web_content_width', 640 );
}
add_action( 'after_setup_theme', 'trident_web_content_width', 0 );
 ...
 */
function trident_web_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'trident-web' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'trident-web' ),
...
add_action( 'widgets_init', 'trident_web_widgets_init' );
